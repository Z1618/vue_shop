    ...
    <div>
        ...
        <el-card class="box-card">
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="4"> 
                    <el-button type="primary"  @click="addDiaologVisable = true">添加用户</el-button>
                </el-col>
            </el-row>   
            <!--用户表-->
        ...
        <el-dialog
            title="提示"
            :visible.sync="addDiaologVisable"
            width="50%"
            @close="addDialogClosed">
            <!--内容主体-->
            <el-form :label-position="labelPosition" label-width="70px" 
            :model="addInfo" ref="addformRef" :rules="addFormRules">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="addDiaologVisable = false">取 消</el-button>
        ...
        <el-dialog
            ...
            label-width="70px" :model="editForm" ref="editFormRef"
            :rules="editFormRules"
            >
...
export default {
    ...
    methods:{
        ...
        handleSizeChange(nowSize){
            this.querryInfo.pagesize=nowSize
            this.getuserList()
        },
        //监听页码值改变事件
        handleCurrentChange(nowPage){
            this.querryInfo.pagenum=nowPage
            this.getuserList()
        },
        //监听switch开关变化
        ...
        test(){
            console.log(this.querryInfo.query)
        },
        //监听添加表单对话框关闭事件
        addDialogClosed(){
       ...
       async showEditDialog(id){
        ...
        editUser(){
            this.$refs.editFormRef.validate( async valid=>{
                ...
                if(res.meta.status !==200){
                    this.$message.error('修改用户请求失败')
                }
                this.$message.success('修改用户请求成功!')
        ...
        async deleteUserById(id){
            const returnInfo=await this.$confirm('此操作将永久删除该用户, 是否继续?', '提示', {
